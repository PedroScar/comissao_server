...
private val HEADERS = arrayListOf("Data e hora", "Responsável", "Tipo de transação", "Promotor(a)", "Valor")


fun FlowContent.includeTabelaDeHistoricoDeTransacoes(
...
private fun exibirLinhaTransacao(transacao: ExtratoVO): List<FlowContent.() -> Unit> {
    return listOf(
        ...
        { miniConta(transacao.contaSaldo) },
        {
