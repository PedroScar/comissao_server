...
//        input(classes = "${if(enabled) "${CoresEnum.HIGH_LIGHT.bg} hover:${CoresEnum.HIGH_MEDIUM.bg} ${CoresEnum.LOW_PURE.text}" else "${CoresEnum.HIGH_DARK.bg} ${CoresEnum.LOW_LIGHT.text} pointer-events-none"} ring-inset mt-1 w-full px-4 py-2 font-semibold ${ArredondamentosEnum.MD} focus:ring-1 focus:ring-${CoresEnum.LOW_PURE}") {
//            type = inputType
//            id = nomeDoCampo
//            name = nomeDoCampo
//            placeholder = hint
